...
def get_config():
    ...
    config.dataset = "radial_dam_break_data_inter_t101_xy101.npz"
    # config.dataset = "radial_dam_break_data_inter_t41_xy41.npz"

    # Weights & Biases
    config.wandb = wandb = ml_collections.ConfigDict()
    wandb.project = "PINN-SWE-DAM"
    wandb.name = "pirate_visc"
    wandb.tag = None
    wandb.notes = "num visc, 101ts, 1 tw, 50k, 2048, nl=8"
    ...
    nondim.visc = None      # Caracteristic numerical viscosity (calculated in train.py)
    ...
    training.max_steps = 50000  # 20000
    ...
    training.g_min = 0.02    # Min value of g for the schedule
