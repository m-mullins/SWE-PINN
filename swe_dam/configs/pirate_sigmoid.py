...
def get_config():
    ...
    wandb.name = "pirate_cf_sig"
    wandb.tag = None
    wandb.notes = "cuteflow, 2 tw, 50k, 2048, nl=8, sigmoid"
    ...
    training.g_schedule = "sigmoid"  # Increase g during training according to a schedule "step", "sigmoid" or None
