...
def get_config():
    ...
    config.mode = "curri"   # "train" or "eval" or "train_eval" or or "eval_s2s" or "train_eval_s2s" or "curri"
    ...
    wandb.name = "default_curri"
    wandb.tag = ["curri_test"]
    ...
    transfer.datasets = ["burgers2d_nt101_nx101_ny101_Re237.mat","burgers2d_nt101_nx101_ny101_Re880.mat","burgers2d_nt101_nx101_ny101_Re1756.mat"]  # List of dataset filenames for curriculum training
    transfer.iterations = [10000, 20000, 40000]  # List of training iterations for each dataset
