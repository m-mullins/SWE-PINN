...
#SBATCH --job-name=b2d
#SBATCH --output=outfiles/b2d.out
...
cd /project/def-soulaima/mmullins/SWE-PINN/burgers2d

# Run program
python ./main.py

# To run  job script:
# In SWE-PINN, run the following command: sbatch scripts/train_burgers2d.sh