...
def get_config():
    ...
    config.mode = "train_eval_s2s"    # "train" or "eval" or "train_eval" or "train_eval_s2s" or "curri"
    config.dataset = "burgers1d_Re1500.mat"
    config.nu = None

    # Weights & Biases
    config.wandb = wandb = ml_collections.ConfigDict()
    wandb.project = "PINN-Burgers"
    wandb.name = "default_s2s"
    wandb.tag = None
    ...
    training.max_steps = 40000 # 40000
    ...
    saving.save_every_steps = 1000  # 1000
