...
def get_config():
    ...
    config.mode = "curri"   # "train" or "eval" or "train_eval"
    ...
    transfer.datasets = ["burgers1d_Re100.mat", "burgers1d_Re400.mat", "burgers1d_Re1000.mat", "burgers1d_Re1500.mat"]  # List of dataset filenames for curriculum training
    ...
    saving.save_every_steps = 1000   # 10000
