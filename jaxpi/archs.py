...
# All available activation funcs
activation_fn = {
    "relu": nn.relu,
    "gelu": nn.gelu,
    "swish": nn.swish,
...
# NNs initialization: Glorot scheme and Random weight factorization
...
# For hard constraints of periodic BCs
...
# Impose FourierEmbs or/and PeriodEmbs: step 1: periodicity. step 2: fourier embedding
...
# Dense layer: y =  Wx+b. This the block for all archs
class Dense(nn.Module):
    features: int
    kernel_init: Callable = glorot_normal() # kernel are weights
    bias_init: Callable = zeros
    reparam: Union[None, Dict] = None # type of initialization: None (glorot) or weight_fact
...
# This is a block (special archs) of a NN
...
# Bottleneck V3: based on midified MLP which is the main arch for PirateNets
