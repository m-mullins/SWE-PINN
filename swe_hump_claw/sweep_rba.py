...
config_flags.DEFINE_config_file(
    "config",
    # "./configs/sweep_pirate_rba.py",
    # "./configs/sweep_default_rba.py",
    "./configs/sweep_plain_rba.py",
...
def main(argv):
    ...
    parameters_dict = {
        "use_rba": {"values": [True, False]},
        "batch_size": {"values": [1024, 2304, 4096, 7744]},
        "sampler": {"values": ["fixed", "structured_random"]},
    }
    ...
    def train_sweep():
        ...
        config.weighting.use_rba = sweep_config.use_rba
        config.weighting.rba_sampler = sweep_config.sampler
