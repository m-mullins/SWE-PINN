...
def get_config():
    ...
    wandb.name = "pirate"
    wandb.tag = ["wall_bc","L-BFGS"]
    wandb.notes = "25k Adam + 5k L-BFGS, double"
    ...
    # transfer.datasets = ["swe_sill_2d_nx128_nt101_g1.0.npz","swe_sill_2d_nx128_nt101_g1.0.npz"]  # List of dataset filenames for curriculum training
    ...
    training.max_steps = 25000  # 20000
    ...
    training.use_lbfgs = True
    training.current_optim = None
    training.lbfgs_batch_size = 4096 # 9216
