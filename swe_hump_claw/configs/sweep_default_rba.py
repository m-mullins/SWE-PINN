...
def get_config():
    ...
    wandb.name = "default_rba"
    wandb.tag = ["wall_bc", "RBA"]
    wandb.notes = "sweep rba colloc"
    ...
    setup.use_visc = True     # Use numerical viscosity in residual eqn
    ...
    training.batch_size_per_device = 2304 # 2304, must be divisible by 32 and have a perfect square root
    ...
    weighting.use_rba = True    # Residual based attention mask for collocation points
    ...
    weighting.rba_warmup = 40000 # Start RBA after n steps
    ...
    logging.log_rba = True
    logging.log_rba_every_steps = [0,10,100,1000,5000,10000,20000,40000]
