...
def get_config():
    ...
    config.dataset = "swe_hump_claw_1d_nx500_nt101_g9.8_x1.0_t1.0_wall.npz"
    # config.dataset = "swe_hump_claw_1d_nx500_nt41_g9.8_x1.0_t1.0_wall.npz"

    # Weights & Biases
    config.wandb = wandb = ml_collections.ConfigDict()
    wandb.project = "PINN-SWE-HUMP-CLAW"
    wandb.name = "pirate_g9"
    wandb.tag = ["wall_bc"]
    wandb.notes = "g=9.8 w/ wall"
    ...
    arch.fourier_emb = ml_collections.ConfigDict({"embed_scale": 1.5, "embed_dim": 256})
